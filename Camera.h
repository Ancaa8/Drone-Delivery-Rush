...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 0.0f);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            forward = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0.0f);
            right = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0.0f);
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 0.0f);
            up = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(up, 0.0f);
